...
exports.getBrasseursAPI = async (req, res) => {
  const listbrewer = await queryAsync(
    "SELECT brewer_id as id, nameBrass, nameTown, ville_departement, ville_code_postal, ville_longitude_deg as lng, ville_latitude_deg as lat  FROM `brewersfrench`INNER JOIN villes_france_free ON nameTown = ville_nom "
  );
